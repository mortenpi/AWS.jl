...
- `"namespace"`: The namespace of the package versions to be copied. The package component
  ...
  Python, NuGet, and Ruby package versions do not contain a corresponding component, package
...
- `"namespace"`: The namespace of the package to delete. The package component that
  ...
  NuGet, and Ruby package versions do not contain a corresponding component, package versions
...
- `"namespace"`: The namespace of the package versions to be disposed. The package
  ...
  namespace.    Python, NuGet, and Ruby package versions do not contain a corresponding
...
- `"namespace"`: The namespace of the package from which to get the associated package
  ...
  namespace of a generic package is its namespace.    Python, NuGet, and Ruby package
...
endpoint for each package format:     generic     maven     npm     nuget     pypi     ruby
    swift
...
- `"namespace"`: The namespace of the package that contains the requested package versions.
  ...
  package is its namespace.    Python, NuGet, and Ruby package versions do not contain a
...
- `"namespace"`: The namespace prefix used to filter requested packages. Only packages with
  ...
  scope.    The namespace of a generic package is its namespace.    Python, NuGet, and Ruby
  package versions do not contain a corresponding component, package versions of those
